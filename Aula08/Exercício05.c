...
// ... cada possibilidade somará em 1 ao número de possibilidades (ao final de uma recursão temos o final de uma possibilidade, ...
// ... ou seja o número de caminhos seguidos pela recursão é igual ao número de possibilidades; imaginando tal recursão como uma...
// ... árvore, a partir da raiz recursiveStairs(n) haverão 2 filhos, e assim por diante até que se chegue em uma folha formando...
// ... então uma possibilidade, que pode ser pensada como o caminho até folha).
